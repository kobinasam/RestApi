...
class loginuser extends REST{
    ...
    function Init(){
        ...
        //var_dump($this->usname); exit;
        $stmt = $sql->Execute($sql->Prepare("SELECT USR_CODE,USR_FIRSTNAME,USR_OTHERNAME,USR_EMAIL,USR_PHOTO FROM app_users WHERE USR_USERNAME=".$sql->Param('a')." AND USR_PASSWORD=".$sql->Param('b')." "),array($this->usname,$password,));
